...
function makeGraphs(error, salaryData) {
    ...
    show_percent_that_are_professor(ndx, 'Female', '#percent-of-women-professors');
    show_percent_that_are_professor(ndx, 'Male', '#percent-of-men-professors');
...
function show_percent_that_are_professor(ndx, gender, element){
